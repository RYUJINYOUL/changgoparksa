...
const FabButton = () => {
  ...
  return (
    <div>
    <div className="md:hidden fixed right-5 bottom-5 pb-4 flex flex-col gap-4">
      {/* <div className="gap-3"> */}
        {openSubMenu && (
          <ul>
      ...
      {/* </div> */}
      <button className="bg-[#001391] w-13 h-13 xs:w-11 xs:h-11 text-white rounded-full shadow-lg transition-transform hover:scale-110" onClick={shownSubMenuHandler}>
 ...
 <div className="md:block fixed right-5 bottom-5 pb-4 flex flex-col gap-4">
      {/* <div className="gap-3"> */}
